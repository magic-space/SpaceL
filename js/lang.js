var lang = {
    ...
    deutsch: {
        ...
        etypes: [
            ...
            "Außerirdisches Flaggschiff",
            "Außerirdischer Planet",
        ],
        ttitles: [
            "Spielanleitung ?",
            "Erkundung",
        ...
        ttexts: [
             "<h4>Das Ziel ist es, Ressourcen zu erhalten und sie dann zu verkaufen, um Technologien zur Verbesserung des Renderings zu kaufen</h4><br><br>1. Sie können mit einer Erkundungsmission beginnen, Sie erhalten Ressourcen und <i class='  rotes Sortiersymbol "Betrag nach oben"></i>Explorationspunkte (EP)<br><br>2. Verkaufen Sie Ihre Waren auf dem Weltraummarkt, um Geld zu verdienen.<br><br>3. Erstellen Sie eine Drohne in den Technologien zu  Automatisieren Sie das Sammeln von Ressourcen.<br><br>4. Wenn Sie über den erforderlichen Geldbetrag verfügen und sich in Gaia befinden, können Sie in eine andere Galaxie reisen.",
             "Die Erkundung ist das Hauptziel.<br> Sie werden neue Orte entdecken, indem Sie <i class='red sort amount up icon'></i> EP und Ressourcen gewinnen.",
             "Der Markt ist der Ort, an dem Sie all Ihre Waren verkaufen und etwas Geld verdienen können.<br> Die Preise sind in jedem System unterschiedlich und ändern sich jeden Tag.<br><br>Es gibt einen Farbcode, um den Wert jeder Ressource anzuzeigen:  <br>- <span class='rouge'>Sehr niedrig</span><br>- <span class='argent'>Niedrig</span><br>- <span class=''>Normal</span  ><br>- <span class='vert'>Hoch</span><br>- <span class='Gold'>Teuer</span>",
             "3 Technologien sind freischaltbar<br>- Eine Drohne, die eine bestimmte Menge des definierten Gegenstands gibt, abhängig von Ihrem aktuellen Drohnenlevel.<br> - Ein Hyperraummodul, das neue Orte freischalten kann.<br>- Ein Hyperantriebsmodul, das dies kann  Reduzieren Sie die Reisekosten zu einem anderen Ort.",
             "<h4>Das Prestigesystem des Spiels</h4><br>Die Galaxie wird dir mehr Inventarplätze geben.<br>Aber es wird auch das <i class='red sort level up icon'></i erhöhen  > EP benötigt, um Ihren Standort zu ändern.<br>Dieses System reduziert auch die Produktionszeit für die Drohne.",
             "Es gibt auch ein Menü, in dem Sie Ihren Spielstand exportieren/importieren oder zurücksetzen oder diese Anleitung erneut öffnen können.<br>Klicken Sie einfach auf Menü in der oberen linken Ecke des Bildschirms.", 
        ],
        general: [
            "Typ",
            "Beschreibung",
